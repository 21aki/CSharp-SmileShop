...
namespace SmileShop.Clients
{
    ...
    public class ShortLinkClient
    {
        ...
        public ShortLinkClient(IHttpContextAccessor accessor, IOptions<SssCommonApiOptions> configuration)
        {
            _request = accessor.HttpContext.Request;
            _client = new RestClient(configuration.Value.ShortLinkApi);
